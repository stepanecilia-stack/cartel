        ...
        {mode === 'create' ? (
          <>
            <p className={`mt-2.5 ${vk.muted}`}>
              Достаточно имени и фамилии — рост, вес и год рождения можно заполнить в карточке позже. После сохранения
              появится <strong className="font-medium text-[#2c2d2e]">шестизначный код</strong>: передайте его коллеге,
              чтобы он добавил того же ученика через «Присоединить», а не создавал дубликат.
            </p>
            <NewStudentForm
              compact
