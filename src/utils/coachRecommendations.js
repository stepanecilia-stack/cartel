...
/**
 * Подпись к сетке эталонов КБП в строке плана. В `standards.js` для всех 19+ лет одна метка «19-22»;
