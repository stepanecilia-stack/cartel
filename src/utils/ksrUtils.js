...
export const getWeights = (studentData = {}) => {
  ...
  if (wf.tacticMode === 'infighter') {
    ...
    return {
      ...
      apeIndex,
      tacticAdvice:
        'Рост ниже ориентира по таблице для этой категории — логичный упор на ближнюю дистанцию и спокойное давление. Нюансы лучше согласовать с тренером под конкретного спортсмена.',
