...
export function buildPortalPersonaSystemPrompt(
  ...
  if (context === 'onboarding_greeting') {
    ...
    scene =
      'Сцена: проверка после матчасти. Ученик видел схему четырёх этапов и три карточки. РОВНО ЧЕТЫРЕ вопроса по одному в сообщении: (1) как называется следующий этап — «Знание»; (2) логический образ; (3) зрительный образ; (4) кинестетический образ. После каждого верного ответа — ||QUIZ_PASS|| и следующий вопрос. Только после четвёртого ||QUIZ_PASS|| говори жать «Дальше». Не говори «жми Дальше» раньше. «Понял» — кнопка платформы, не отдельный этап. Не путай образы с «Понял». Подсказки после 10 ошибок — «начинается на…».'
