...
async function summarizePersonaMemory(messages, existingMemory, trainingGoals, context) {
  ...
  const prompt = [
    ...
    '',
    'levelNotes — до 800 символов: спортивный опыт, физическая подготовка (отжимания, подтягивания — со слов ученика), уровень, цели, мотивация, страхи, самооценка. Крупные блоки, без мелочей.',
